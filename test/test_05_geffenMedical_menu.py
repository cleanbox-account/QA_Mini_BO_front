...
# version ='1.0'
# ---------------------------------------------------------------------------
""" testing with pytest tool. Testing of Mini BO for Gefen Medical - menu pages"""
# ---------------------------------------------------------------------------
import pytest
...
class TestGeffenMedicalBO(BaseClass):
    ...
    @pytest.mark.parametrize('role', [ pytest.param('GeffenMedical' ),   #gefenMedical
                                                    ])
    def test_05_for_geffen_medical_menu_overview(self, role):
