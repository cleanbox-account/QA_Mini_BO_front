...
# version ='1.0'
# ---------------------------------------------------------------------------
""" testing with pytest tool. Testing of Mini BO for YDM - new order pages"""
# ---------------------------------------------------------------------------
import random
import pytest
...
class TestYDMNewOrder(BaseClass):
    ...
    @pytest.mark.parametrize('role', [ pytest.param('YDM' ),   
                                                    ])
    def test_13_for_ydm_new_order(self, role):
