...
# version ='1.0'
# ---------------------------------------------------------------------------
""" testing with pytest tool. Testing of Mini BO for HFD - new order pages"""
# ---------------------------------------------------------------------------
import random
import pytest
...
class TestHFDNewOrder(BaseClass):
    ...
    @pytest.mark.parametrize('role', [ pytest.param('HFD'),   
                                                    ])
    def test_15_for_HFD_new_order(self, role):
        ...
        while not has_new_order:
            ...
            new_pcg_number="HFD"+str(random.randint(10000000, 99999999))
